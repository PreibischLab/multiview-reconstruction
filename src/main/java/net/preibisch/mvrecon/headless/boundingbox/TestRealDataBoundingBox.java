...
public class TestRealDataBoundingBox
{
	public static void main( String[] args ) throws SpimDataException
	{
		...
		FusionTools.displayCopy( FusionTools.fuseVirtual( spimData, viewIds, true, false, 1, bb, 2.0 ), estimation.getMinIntensity(), estimation.getMaxIntensity(), service ).show();
	}
}
