...
public abstract class FilteredAndGroupedExplorerPanel<AS extends AbstractSpimData< ? extends AbstractSequenceDescription< ?, ?, ? > >, X extends XmlIoAbstractSpimData< ?, AS >>
